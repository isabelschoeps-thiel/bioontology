...
# Attention - this Ontology Development Kit is Evidence 
...
# Evidence of  SIA Security Intelligence Artefact

* ***Autorin:***, Frau Isabel Schöps geb. Thiel  @isabelschoeps-thiel (GitHub)

https://github.com/isabelschoeps-thiel/bioontology/ontology-development-kit/graphs/contributors

# whats kind of contributors ? 
...
- Community:
  ...
  -  We also have an active community on Slack; you can request access by making a ticket [here](https://github.com/INCATools/ontology-development-kit/issues) as 
